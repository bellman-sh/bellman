#!/usr/bin/env bash
PORT=$(cat "/Users/mcfearsome/src/github.com/mcfearsome/quorai/.dual-graph/run/claude/mcp_port" 2>/dev/null || echo 8080)
...
if [[ -f "/Users/mcfearsome/src/github.com/mcfearsome/quorai/CONTEXT.md" ]]; then
  echo ""
  echo "=== CONTEXT.md ==="
  cat "/Users/mcfearsome/src/github.com/mcfearsome/quorai/CONTEXT.md"
  echo "=== end CONTEXT.md ==="
fi
# Inject AUDIT_CONTEXT.md if recent (< 7 days) — tells Claude what to fix
AUDIT_CTX="/Users/mcfearsome/src/github.com/mcfearsome/quorai/.dual-graph/AUDIT_CONTEXT.md"
if [[ -f "$AUDIT_CTX" ]]; then
...
STORE="/Users/mcfearsome/src/github.com/mcfearsome/quorai/.dual-graph/context-store.json"
